...
import { Cart, HomeScreen, Profile } from '../screens';
  ...
  return (
    <Tab.Navigator screenOptions={{ headerShown: false }}>
      <Tab.Screen 
        ...
        options={{
          tabBarLabel: ({ focused }) => <TabItemTitle focused={focused} title='Home'/>,
          tabBarIcon: ({ focused }) =>  
            focused ? (
              <Home width={24} height={24} fill={COLORS.primary} />
            ) : (
      ...
      <Tab.Screen 
        ...
        component={Cart}
        options={{
          tabBarLabel: ({ focused }) => <TabItemTitle focused={focused} title='Cart'/>,
          tabBarIcon: ({ focused }) =>  
            focused ? (
      ...
      <Tab.Screen 
        ...
        component={Profile}
        options={{
          tabBarLabel: ({ focused }) => <TabItemTitle focused={focused} title='Profile'/>,
          tabBarIcon: ({ focused }) =>  
            focused ? (
